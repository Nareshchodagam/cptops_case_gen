...
parser.add_option("--patchset", dest="patch_set", default="none", help="Patchset version")
parser.add_option("--patch_version", dest="patch_version", default="none", help="system_update.sh version")
